...
optimized_hgb = HistGradientBoostingRegressor(
...
optimized_hgb.fit(X_train, y_train)
...
y_train_pred = evaluate_model(optimized_hgb, X_train, y_train, "Train")
y_test_pred = evaluate_model(optimized_hgb, X_test, y_test, "Test")
...
y_perf_pred = optimized_hgb.predict(X_perf_processed)
...
optimized_hgb2 = HistGradientBoostingRegressor(
    max_iter=int(best_params2['max_iter']),
...
optimized_hgb2.fit(X_train2, y_train2)

# Evaluate and visualize final model
y_train2_pred = evaluate_model(optimized_hgb2, X_train2, y_train2, "Train (New)")
y_test2_pred = evaluate_model(optimized_hgb2, X_test2, y_test2, "Test (New)")
