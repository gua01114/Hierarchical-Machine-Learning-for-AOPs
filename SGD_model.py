...
y_train_pred = evaluate_model(optimized_sgd, X_train, y_train, "Train")
y_test_pred = evaluate_model(optimized_sgd, X_test, y_test, "Test")
...
y_perf_pred = optimized_sgd.predict(X_perf_processed)
...
optimized_sgd2 = SGDRegressor(
    penalty=['l2', 'l1', 'elasticnet'][best_params2['penalty']],
    alpha=best_params2['alpha'],
    max_iter=int(best_params2['max_iter']),
    random_state=42
)
optimized_sgd2.fit(X_train2, y_train2)

# Evaluate and visualize final model
y_train2_pred = evaluate_model(optimized_sgd2, X_train2, y_train2, "Train (New)")
y_test2_pred = evaluate_model(optimized_sgd2, X_test2, y_test2, "Test (New)")
