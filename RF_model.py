...
# 학습 및 테스트 데이터 평가
y_train_pred = evaluate_model(optimized_rf, X_train, y_train, "Train")
y_test_pred = evaluate_model(optimized_rf, X_test, y_test, "Test")
...
y_perf_pred = optimized_rf.predict(X_perf_processed)
...
optimized_rf2 = RandomForestRegressor(
...
y_train2_pred = evaluate_model(optimized_rf2, X_train2, y_train2, "Train (New)")
y_test2_pred = evaluate_model(optimized_rf2, X_test2, y_test2, "Test (New)")
