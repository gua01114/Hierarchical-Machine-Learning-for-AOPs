...
save_path = r"C:\Users\USER\Desktop\JHW\01.Research\12.KHU\03.Results\DT"
...
y_train_pred = evaluate_model(optimized_dt, X_train, y_train, "Train")
y_test_pred = evaluate_model(optimized_dt, X_test, y_test, "Test")
...
y_perf_pred = optimized_dt.predict(X_perf_processed)
...
optimized_dt2 = DecisionTreeRegressor(
...
optimized_dt2.fit(X_train2, y_train2)

# Evaluate and visualize final model
y_train2_pred = evaluate_model(optimized_dt2, X_train2, y_train2, "Train (New)")
y_test2_pred = evaluate_model(optimized_dt2, X_test2, y_test2, "Test (New)")
