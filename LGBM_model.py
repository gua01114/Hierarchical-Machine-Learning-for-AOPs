...
y_train_pred = evaluate_model(optimized_lgbm, X_train, y_train, "Train")
y_test_pred = evaluate_model(optimized_lgbm, X_test, y_test, "Test")
...
y_perf_pred = optimized_lgbm.predict(X_perf_processed)
...
optimized_lgbm2 = LGBMRegressor(
    ...
    num_leaves=int(best_params2['num_leaves']),
    random_state=42
)
optimized_lgbm2.fit(X_train2, y_train2)

# Evaluate and visualize final model
y_train2_pred = evaluate_model(optimized_lgbm2, X_train2, y_train2, "Train (New)")
y_test2_pred = evaluate_model(optimized_lgbm2, X_test2, y_test2, "Test (New)")
