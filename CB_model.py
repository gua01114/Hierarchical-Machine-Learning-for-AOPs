...
optimized_cb = CatBoostRegressor(
...
optimized_cb2 = CatBoostRegressor(
    iterations=int(best_params2['iterations']),
    depth=int(best_params2['depth']),
    learning_rate=float(best_params2['learning_rate']),
    random_state=42,
    verbose=0
)
optimized_cb2.fit(X_train2, y_train2)
